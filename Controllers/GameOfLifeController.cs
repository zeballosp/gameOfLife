...
public class GameOfLifeController : ControllerBase
{
    ...
    public async Task<IActionResult> Get(int id)
    {
        ...
        var result = board.XAwayState(board.Array,1);
    ...
    public async Task<IActionResult> Get(int id, int numberOfStatesAway)
    {
        ...
        var result = board.XAwayState(board.Array, numberOfStatesAway);
    ...
    public async Task<IActionResult> GetFinalState(int id, int numberOfAttemps)
    {
        ...
        var result = board.FinalState(board.Array, numberOfAttemps);
        if (result == null)
        {
